...
namespace GemCard
{
	...
	public class CardNative : CardBase, IDisposable
	{
		...
		public override APDUResponse Transmit(APDUCommand ApduCmd)
		{
			...
			{
				ApduBuffer = new byte[APDUCommand.APDU_MIN_LENGTH + ApduCmd.Data.Length];
                Buffer.BlockCopy(ApduCmd.Data, 0, ApduBuffer, APDUCommand.APDU_MIN_LENGTH, ApduCmd.Data.Length);
